...
def run_benchmark():
    ...
    # 1. Full Prediction for multi-chain sample
    print("\n--- Starting Full Prediction for multi-chain sample ---")
    ...
    # 2. Score Only for multi-chain sample
    print("\n--- Starting Score Only for multi-chain sample ---")
